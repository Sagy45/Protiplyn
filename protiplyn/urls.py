...
from protiplyn import settings
...
from equipment.views import (
    ...
    VehicleStorageListView,
    VehicleStorageCreateView,
    VehicleStorageUpdateView,
    VehicleStorageDeleteView,
    MaskListView,
    MaskCreateView,
    MaskUpdateView,
    MaskDeleteView,
    ...
    UpdateStatusView,
    EquipmentDetailView,
    UpcomingRevisionListView, HomeView,
)
...
urlpatterns = [
    ...
    path(
        "<int:pk>/edit/", EquipmentTypeUpdateView.as_view(), name="equipmenttype_edit"
    ),
    path(
        "<int:pk>/delete/",
        EquipmentTypeDeleteView.as_view(),
        name="equipmenttype_delete",
    ),
    ...
    path(
        ...
        VehicleStorageUpdateView.as_view(),
        name="vehicle_edit",
    ),
    path(
        "vehicles/<int:pk>/delete/",
        VehicleStorageDeleteView.as_view(),
        name="vehicle_delete",
    ),
    # Mask
    ...
    path(
        "adpmulti/<int:pk>/delete/",
        ADPMultiDeleteView.as_view(),
        name="adpmulti_delete",
    ),
    # ADPSingle
    ...
    path(
        "adpsingle/<int:pk>/edit/", ADPSingleUpdateView.as_view(), name="adpsingle_edit"
    ),
    path(
        "adpsingle/<int:pk>/delete/",
        ADPSingleDeleteView.as_view(),
        name="adpsingle_delete",
    ),
    # AirTank
    ...
    path(
        "airtanks/<int:pk>/delete/", AirTankDeleteView.as_view(), name="airtank_delete"
    ),
    # PCHO
    ...
    path(
        "completes/<int:pk>/edit/", CompleteUpdateView.as_view(), name="complete_edit"
    ),
    path(
        "completes/<int:pk>/delete/",
        CompleteDeleteView.as_view(),
        name="complete_delete",
    ),
    path(
        "stations/<int:pk>/equipment/",
        StationEquipmentListView.as_view(),
        name="station_equipment",
    ),
    # Upcoming revision
    path(
        "equipment/revision-upcoming/",
        UpcomingRevisionListView.as_view(),
        name="upcoming_revisions",
    ),
    # Accounts
    ...
    # nový archiv
    path(
        "stations/<int:pk>/equipment/archive/",
        ArchiveEquipmentListView.as_view(),
        name="station_equipment_archive",
    ),
    # retire (přesune do archivu)
    path(
        "equipment/<int:pk>/retire/", RetireEquipment.as_view(), name="equipment_retire"
    ),
    # restore (zpět z archivu do aktivních)
    path(
        "equipment/<int:pk>/restore/",
        RestoreEquipment.as_view(),
        name="equipment_restore",
    ),
    # formulare
